<button onclick="window.__nourToggleTheme()" class="theme-toggle" aria-label="<?php echo e(__('app.switch_theme')); ?>" title="<?php echo e(__('app.switch_theme')); ?>">
...
<script>
    if (!window.__nourToggleTheme) {
        window.__nourToggleTheme = function () {
            ...
            fetch('<?php echo e(url('/theme')); ?>/' + next, {
                method: 'POST',
                headers: {
...
</script><?php /**PATH C:\Users\engya\Desktop\جامعة الشهباء 2026\سارة مشروع التخرج\smart_educational_platform\resources\views/components/theme-toggle.blade.php ENDPATH**/ ?>